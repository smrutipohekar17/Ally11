        ...
        butNextM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(qidM<5){
                    ...
                    SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(Test.this);
                    //now get Editor
                    ...
                    butNextE.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(qidE<5){
                                ...
                                SharedPreferences sharedPref2 = PreferenceManager.getDefaultSharedPreferences(Test.this);
                                //now get Editor
                                ...
                                butNextN.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        if(qidN<5){
                                            ...
                                            SharedPreferences sharedPref3 = PreferenceManager.getDefaultSharedPreferences(Test.this);
                                            //now get Editor
                                            ...
                                            butNextT.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    ...
                                                    if(qidT<5){
                                                        ...
                                                        SharedPreferences sharedPref4 = PreferenceManager.getDefaultSharedPreferences(Test.this);
                                                        //now get Editor
                                                        ...
                                                        Intent intentR=new Intent(Test.this,ResultActivity.class);
